...
**安装：** 打开 `chrome://extensions`，开启"开发者模式"，选择
"加载已解压的扩展程序"，指向本仓库目录即可。

**上游项目：** 本仓库是 [noVNC](https://github.com/novnc/noVNC)（MPL 2.0）
的分支。noVNC 是基于 HTML5/WebSocket 的 VNC 客户端，可在任何现代浏览器中运行。
