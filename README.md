...
**Install:** open `chrome://extensions`, enable "Developer mode", click
"Load unpacked", and select this repository directory.

**Upstream:** a fork of [noVNC](https://github.com/novnc/noVNC) (MPL 2.0), an
HTML5 VNC client that runs in any modern browser over WebSockets.
